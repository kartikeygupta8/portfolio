...
export const metadata: Metadata = {
  ...
  description:
    'Full-Stack Developer with 7 years of experience building scalable AI-first systems. Node.js, React, Groq Llama 3.3, MCP agents, agentic workflows. 38% AI auto-resolution without human intervention. Open to senior & lead roles.',
  keywords: [
  ...
  openGraph: {
    title: 'Kartikey Gupta — Senior Full-Stack Developer & GenAI Engineer',
    description: 'Full-Stack Developer with 7 years building scalable AI-first systems — MCP agents, RAG pipelines, Node.js, React. 38% AI auto-resolution without human intervention. Open to senior & lead roles.',
